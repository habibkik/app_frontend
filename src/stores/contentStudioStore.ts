...
export const useContentStudioStore = create<ContentStudioStore>((set) => ({
  ...
  proImages: [
    ...
    // Marketing Creatives
    { id: "marketing-hero-banner", label: "Hero Banner", prompt: "", imageUrl: null, isGenerating: false, section: "marketing" },
    { id: "marketing-before-after", label: "Before & After", prompt: "", imageUrl: null, isGenerating: false, section: "marketing" },
    { id: "marketing-testimonials", label: "Testimonials", prompt: "", imageUrl: null, isGenerating: false, section: "marketing" },
    { id: "marketing-features", label: "Features Grid", prompt: "", imageUrl: null, isGenerating: false, section: "marketing" },
    { id: "marketing-trust-badges", label: "Trust Badges", prompt: "", imageUrl: null, isGenerating: false, section: "marketing" },
    { id: "marketing-ingredients", label: "Ingredients/Specs", prompt: "", imageUrl: null, isGenerating: false, section: "marketing" },
    { id: "marketing-urgency-cta", label: "Urgency CTA", prompt: "", imageUrl: null, isGenerating: false, section: "marketing" },
    { id: "marketing-social-proof", label: "Social Proof", prompt: "", imageUrl: null, isGenerating: false, section: "marketing" },
    { id: "marketing-guarantee", label: "Guarantee Seal", prompt: "", imageUrl: null, isGenerating: false, section: "marketing" },
    { id: "marketing-order-footer", label: "Order Footer", prompt: "", imageUrl: null, isGenerating: false, section: "marketing" },
  ],
