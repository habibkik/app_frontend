...
const statsConfig: Record<DashboardMode, StatItem[]> = {
  buyer: [
  ...
  producer: [
    { title: "BOMs Generated", value: "18", change: "+4%", positive: true, icon: FileText },
    ...
    { title: "Cost Accuracy", value: "96%", change: "+2%", positive: true, icon: TrendingUp },
  ],
  seller: [
    { title: "Market Analyses", value: "89", change: "+6%", positive: true, icon: FileText },
    { title: "Products Listed", value: "1,247", change: "+18%", positive: true, icon: Users },
    { title: "Revenue MTD", value: "$45.8K", change: "-3%", positive: false, icon: DollarSign },
    { title: "Win Rate", value: "4.2%", change: "+0.8%", positive: true, icon: TrendingUp },
  ],
};
