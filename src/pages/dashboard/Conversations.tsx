...
const CHANNEL_COLORS: Record<string, string> = {
  email: "bg-blue-500/15 text-blue-700 dark:text-blue-400 border-blue-500/20",
  linkedin: "bg-sky-500/15 text-sky-700 dark:text-sky-400 border-sky-500/20",
  whatsapp: "bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 border-emerald-500/20",
  sms: "bg-violet-500/15 text-violet-700 dark:text-violet-400 border-violet-500/20",
  phone: "bg-amber-500/15 text-amber-700 dark:text-amber-400 border-amber-500/20",
  facebook: "bg-indigo-500/15 text-indigo-700 dark:text-indigo-400 border-indigo-500/20",
  instagram: "bg-pink-500/15 text-pink-700 dark:text-pink-400 border-pink-500/20",
  tiktok: "bg-rose-500/15 text-rose-700 dark:text-rose-400 border-rose-500/20",
  twitter: "bg-cyan-500/15 text-cyan-700 dark:text-cyan-400 border-cyan-500/20",
};
...
function ChannelBadge({ channel }: { channel?: string }) {
  ...
  const colors = CHANNEL_COLORS[channel] || "bg-muted text-muted-foreground border-border";
  return (
    <span className={cn("inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[10px] font-medium border", colors)}>
