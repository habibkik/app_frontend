      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sidebar-foreground/60 text-sm mb-6 max-w-xs">
              AI-powered B2B trade platform connecting buyers, producers, and 
              sellers worldwide.
            </p>
            <div className="space-y-2 text-sm text-sidebar-foreground/60">
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4" />
                <span>hello@tradeplatform.com</span>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="pt-8 border-t border-sidebar-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-sidebar-foreground/50">
            © 2025 TradePlatform. All rights reserved.
          </p>
