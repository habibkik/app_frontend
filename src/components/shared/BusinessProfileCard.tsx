 ...
 * Expandable card showing detailed business information
 */
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        {geoLocation.city}
                        {geoLocation.state && `, ${geoLocation.state}`}, {geoLocation.country}
                      </p>
                    </div>
                    {googleMapsUrl && (
                      <Button
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid gap-2 text-sm">
                    {businessProfile.companySize && (
                      <div className="flex items-center gap-2">
                        ...
                        <span>{businessProfile.companySize} employees</span>
                      </div>
                    )}
                    ...
                    {businessProfile.annualRevenue && (
                      <div className="flex items-center gap-2">
                        ...
                        <span>{businessProfile.annualRevenue}</span>
                      </div>
                    )}
                  </div>
                  ...
                  {businessProfile.certifications && businessProfile.certifications.length > 0 && (
                    <div className="mt-3">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {businessProfile.certifications.map((cert) => (
                  ...
                  {businessProfile.specializations && businessProfile.specializations.length > 0 && (
                    <div className="mt-3">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {businessProfile.specializations.map((spec) => (
